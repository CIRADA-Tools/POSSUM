"""
Given RA and Dec coordinates of a source (in degrees), make a plot. 

This is not for an arbitrary position. The source must already be in the source list.
"""
...
ra_deg=np.float(sys.argv[4]) # degrees
dec_deg=np.float(sys.argv[5]) # degrees
